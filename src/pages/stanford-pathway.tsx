...
export const StanfordPathwayPage = () => {
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="relative">
                    <div class="absolute -top-4 -left-4 w-24 h-24 bg-primary-50 rounded-full mix-blend-multiply filter blur-xl opacity-70"></div>
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start group">
                            <div class="w-14 h-14 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0 mr-6 group-hover:bg-primary transition duration-300">
                                <i class="fas fa-chalkboard-teacher text-2xl text-primary group-hover:text-white transition duration-300"></i>
                            </div>
                            <div>
                        ...
                        <div class="flex items-start group">
                            <div class="w-14 h-14 bg-primary-100 rounded-xl flex items-center justify-center flex-shrink-0 mr-6 group-hover:bg-primary transition duration-300">
                                <i class="fas fa-lightbulb text-2xl text-primary group-hover:text-white transition duration-300"></i>
                            </div>
                            <div>
                        ...
                        <div class="flex items-start group">
                            <div class="w-14 h-14 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0 mr-6 group-hover:bg-primary transition duration-300">
                                <i class="fas fa-rocket text-2xl text-primary group-hover:text-white transition duration-300"></i>
                            </div>
                            <div>
    ...
    <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-primary font-bold tracking-wider uppercase text-sm mb-2 block">The Roadmap</span>
            ...
            <div class="space-y-12">
                 ...
                 <div class="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-gray-100 hover:shadow-xl transition duration-300 relative overflow-hidden">
                    ...
                    <div class="grid md:grid-cols-12 gap-8 relative z-10">
                        <div class="md:col-span-4">
                            <div class="inline-block bg-primary text-white px-4 py-1 rounded-full text-sm font-bold mb-4">Stage 1</div>
                        ...
                        <div class="md:col-span-8 grid sm:grid-cols-2 gap-8 border-t md:border-t-0 md:border-l border-gray-100 pt-8 md:pt-0 md:pl-8">
                            <div>
                                <h4 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fas fa-bullseye text-primary mr-2"></i> Objectives</h4>
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fas fa-cogs text-primary mr-2"></i> Methods</h4>
                                <ul class="space-y-3 text-gray-600 text-sm">
                ...
                <div class="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-gray-100 hover:shadow-xl transition duration-300 relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-64 h-64 bg-primary-50 rounded-bl-full -mr-16 -mt-16 opacity-50"></div>
                     <div class="grid md:grid-cols-12 gap-8 relative z-10">
                        <div class="md:col-span-4">
                            <div class="inline-block bg-primary text-white px-4 py-1 rounded-full text-sm font-bold mb-4">Stage 2</div>
                        ...
                        <div class="md:col-span-8 grid sm:grid-cols-2 gap-8 border-t md:border-t-0 md:border-l border-gray-100 pt-8 md:pt-0 md:pl-8">
                            <div>
                                <h4 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fas fa-bullseye text-primary mr-2"></i> Objectives</h4>
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Design Thinking Framework Mastery</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Critical Thinking & Analysis</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Leadership & Teamwork</li>
                                </ul>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fas fa-cogs text-primary mr-2"></i> Methods</h4>
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Stanford Design Challenges</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Innovation Labs & Prototyping</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Hackathons & Competitions</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Stage 3 -->
                <div class="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-gray-100 hover:shadow-xl transition duration-300 relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-64 h-64 bg-primary-100 rounded-bl-full -mr-16 -mt-16 opacity-50"></div>
                     <div class="grid md:grid-cols-12 gap-8 relative z-10">
                        <div class="md:col-span-4">
                            <div class="inline-block bg-primary text-white px-4 py-1 rounded-full text-sm font-bold mb-4">Stage 3</div>
                        ...
                        <div class="md:col-span-8 grid sm:grid-cols-2 gap-8 border-t md:border-t-0 md:border-l border-gray-100 pt-8 md:pt-0 md:pl-8">
                            <div>
                                <h4 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fas fa-bullseye text-primary mr-2"></i> Objectives</h4>
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Advanced Research & Innovation</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Entrepreneurial Mindset</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Global Competency</li>
                                </ul>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 mb-4 flex items-center"><i class="fas fa-cogs text-primary mr-2"></i> Methods</h4>
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Real-World Startup Projects</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Patents & Publications</li>
                                    <li class="flex items-start"><span class="w-1.5 h-1.5 bg-primary-400 rounded-full mt-2 mr-2 flex-shrink-0"></span>Alumni Mentorship</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="p-8 rounded-2xl bg-gray-50 hover:bg-white border border-gray-100 hover:shadow-xl transition duration-300 group text-center">
                    ...
                    <p class="text-sm font-bold text-primary uppercase tracking-wider mb-2">Academic Excellence</p>
                    <p class="text-gray-500 text-sm">Target Score for Board Exams</p>
                </div>

                <div class="p-8 rounded-2xl bg-gray-50 hover:bg-white border border-gray-100 hover:shadow-xl transition duration-300 group text-center">
                    <div class="w-16 h-16 mx-auto bg-primary-50 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition duration-300">
                        <i class="fas fa-lightbulb text-3xl text-primary"></i>
                    </div>
                    <div class="text-4xl font-bold text-gray-900 mb-2">5+</div>
                    <p class="text-sm font-bold text-primary uppercase tracking-wider mb-2">Innovation Projects</p>
                ...
                <div class="p-8 rounded-2xl bg-gray-50 hover:bg-white border border-gray-100 hover:shadow-xl transition duration-300 group text-center">
                    ...
                    <p class="text-sm font-bold text-primary uppercase tracking-wider mb-2">Key Competitions</p>
                ...
                <div class="p-8 rounded-2xl bg-gray-50 hover:bg-white border border-gray-100 hover:shadow-xl transition duration-300 group text-center">
                    ...
                    <p class="text-sm font-bold text-primary uppercase tracking-wider mb-2">Leadership</p>
    ...
    <section class="py-24 bg-gray-900 text-white overflow-hidden relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="text-primary font-bold tracking-wider uppercase text-sm mb-2 block">The Toolkit</span>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                             <i class="fas fa-book-reader text-2xl text-primary mt-1 mr-4"></i>
                             <div>
                        ...
                        <div class="flex items-start">
                             <i class="fas fa-chart-pie text-2xl text-primary-400 mt-1 mr-4"></i>
                             <div>
                    ...
                    <div class="mt-10">
                         <a href="/contact" class="inline-flex items-center bg-primary hover:bg-primary-700 text-white px-8 py-4 rounded-xl font-bold transition shadow-lg border border-transparent hover:border-primary-400">
                ...
                <div class="relative">
                    ...
                    <div class="grid grid-cols-3 gap-2 p-4 bg-white/10 backdrop-blur rounded-2xl border border-white/10 transform rotate-2 hover:rotate-0 transition duration-500">
                        <div class="col-span-1 bg-primary-500/20 rounded-lg p-4 h-24 flex items-center justify-center"><i class="fas fa-handshake text-2xl text-primary-400"></i></div>
                        <div class="col-span-1 bg-primary-600/20 rounded-lg p-4 h-24 flex items-center justify-center"><i class="fas fa-tasks text-2xl text-primary-300"></i></div>
                        <div class="row-span-2 bg-primary-400/20 rounded-lg p-4 flex items-center justify-center"><i class="fas fa-gift text-4xl text-primary-200"></i></div>
                        <div class="col-span-1 bg-primary-700/20 rounded-lg p-4 h-24 flex items-center justify-center"><i class="fas fa-users text-2xl text-primary-400"></i></div>
                        <div class="col-span-1 bg-primary-800/20 rounded-lg p-4 h-24 flex items-center justify-center"><i class="fas fa-heart text-2xl text-primary-300"></i></div>
                        <div class="col-span-1 bg-primary-500/20 rounded-lg p-4 h-20 flex items-center justify-center"><i class="fas fa-tag text-2xl text-primary-200"></i></div>
                        <div class="col-span-2 bg-primary-900/20 rounded-lg p-4 h-20 flex items-center justify-center"><i class="fas fa-chart-line text-2xl text-primary-100"></i></div>
                    </div>
    ...
    <section class="py-24 bg-white relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <a href="/admissions" class="inline-flex items-center justify-center bg-primary text-white hover:bg-primary-700 px-10 py-4 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition transform hover:-translate-y-1">
                    Apply for Admission
                </a>
