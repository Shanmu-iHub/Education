    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div>
                     <span class="text-primary font-bold tracking-wider uppercase text-sm mb-2 block">Our Philosophy</span>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:-translate-y-1 transition duration-300">
                    <div class="w-16 h-16 bg-primary-50 rounded-2xl flex items-center justify-center mb-6">
                        <i class="fas fa-baby text-3xl text-primary"></i>
                    </div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-500">
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Communication & language</li>
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Indoor & outdoor learning</li>
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Motor skills development</li>
                    </ul>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:-translate-y-1 transition duration-300">
                    <div class="w-16 h-16 bg-primary-100 rounded-2xl flex items-center justify-center mb-6">
                        <i class="fas fa-child-reaching text-3xl text-primary"></i>
                    </div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-500">
                         <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Phonics & early reading</li>
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Basic mathematics concepts</li>
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Creative arts & design</li>
                    </ul>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:-translate-y-1 transition duration-300">
                    ...
                    <ul class="space-y-3 text-sm text-gray-500">
                         <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Blending & segmentation</li>
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>Early writing skills</li>
                        <li class="flex items-center"><i class="fas fa-check text-primary mr-2"></i>School readiness preparation</li>
                    </ul>
                </div>
            </div>
        </div>
...
export const PrimaryPage = () => {
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="text-primary font-bold tracking-wider uppercase text-sm mb-2 block">Curriculum</span>
                ...
                <div class="relative">
                    <div class="absolute -top-4 -right-4 w-24 h-24 bg-primary-100 rounded-full mix-blend-multiply filter blur-xl opacity-70"></div>
                     <div class="absolute -bottom-4 -left-4 w-24 h-24 bg-primary-50 rounded-full mix-blend-multiply filter blur-xl opacity-70"></div>
            ...
            <div class="bg-white rounded-3xl p-12 shadow-sm border border-gray-100">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div class="w-16 h-16 mx-auto bg-primary-50 rounded-full flex items-center justify-center mb-4 text-primary text-2xl"><i class="fas fa-globe"></i></div>
                     ...
                     <div class="text-center">
                        <div class="w-16 h-16 mx-auto bg-primary-100 rounded-full flex items-center justify-center mb-4 text-primary text-2xl"><i class="fas fa-graduation-cap"></i></div>
                     ...
                     <div class="text-center">
                        <div class="w-16 h-16 mx-auto bg-primary-50 rounded-full flex items-center justify-center mb-4 text-primary text-2xl"><i class="fas fa-hands-helping"></i></div>
                        <h3 class="font-bold text-gray-900 mb-2">Social Justice</h3>
                        <p class="text-sm text-gray-500">Fostering strong community values</p>
                    </div>
                     <div class="text-center">
                        <div class="w-16 h-16 mx-auto bg-primary-100 rounded-full flex items-center justify-center mb-4 text-primary text-2xl"><i class="fas fa-brain"></i></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="bg-primary-50 rounded-3xl p-10">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                             <div class="w-6 h-6 rounded-full bg-primary-100 flex items-center justify-center mr-3 mt-0.5"><i class="fas fa-check text-primary text-xs"></i></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div class="bg-white p-6 rounded-xl text-center shadow-sm hover:shadow-md transition">
                    <i class="fas fa-heart text-3xl text-primary mb-3"></i>
                ...
                <div class="bg-white p-6 rounded-xl text-center shadow-sm hover:shadow-md transition">
                    <i class="fas fa-tools text-3xl text-primary mb-3"></i>
